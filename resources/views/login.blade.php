    ...
    <style>
        ...
        *::after {
        ...
        .brand-icon {
            ...
            font-size: 1.1rem;
            box-shadow: 0 2px 8px rgba(45, 138, 78, .45);
        }
        ...
        .btn-login:hover {
            ...
            box-shadow: 0 4px 16px rgba(45, 138, 78, .5);
        }
        ...
        .btn-submit:hover {
            transform: translateY(-1px);
            box-shadow: 0 5px 16px rgba(45, 138, 78, .4);
        }
    ...
    <div class="hero" id="hero">
        ...
        <div class="hero-stats">
            <div class="stat">
                ...
                <div class="stat-lbl">Puskesmas</div>
            </div>
            <div class="stat-div"></div>
            <div class="stat">
                <div class="stat-val">6,62%</div>
                <div class="stat-lbl">Prevalensi 2025</div>
            </div>
            <div class="stat-div"></div>
            <div class="stat">
                <div class="stat-val">2020–25</div>
                <div class="stat-lbl">Data Tersedia</div>
            </div>
        </div>
    </div>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="fg">
                    ...
                    <div class="pw-wrap">
                        ...
                        <button type="button" class="pw-eye" id="btnEye"
                            aria-label="Tampilkan password">👁️</button>
                    </div>
                </div>
